...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap -mx-3">
                ...
                <div class="w-full md:w-1/2 px-3">
                    ...
                    <div class="mb-4 flex items-center">
                        <label for="name" class="w-1/3 text-gray-700 font-semibold">Nama</label>
                        <input type="text" 
                                id="name" 
                                wire:model="name" 
                                class="w-2/3 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    </div>
                    ...
                    <div class="mb-4 flex items-center">
                        <label for="password" class="w-1/3 text-gray-700 font-semibold">Password</label>
                        <input type="password" 
                                id="password" 
                                wire:model="password" 
                                class="w-2/3 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    ...
                    <div class="mb-4 flex items-center">
                        <label for="role" class="w-1/3 text-gray-700 font-semibold">Role</label>
                        <select
                            id="role"
                            wire:model="role"
                            class="w-2/3 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
    ...
    <div class="my-3 p-6 bg-white rounded-lg shadow">
        <h4 class="text-lg font-semibold mb-4">Data User</h4>
        <div class="pb-3 pt-3">
            <input type="text" placeholder="Search..." wire:model.live="cari" class="w-1/4 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
        ...
        <table class="min-w-full table-auto border-collapse border border-gray-300">
            <thead>
                <tr class="bg-gray-100">
                    <th class="border border-gray-300 px-3 py-2 cursor-pointer">No</th>
                    <th class="border border-gray-300 px-3 py-2 cursor-pointer" @if ($sortcolom == 'name') {{ $sortdirection }} @endif wire:click="sort('name')">Nama</th>
                    <th class="border border-gray-300 px-3 py-2 cursor-pointer" @if ($sortcolom == 'email') {{ $sortdirection }} @endif wire:click="sort('email')">Email</th>
                    <th class="border border-gray-300 px-3 py-2 cursor-pointer" @if ($sortcolom == 'role') {{ $sortdirection }} @endif wire:click="sort('role')">Role</th>
                    <th class="border border-gray-300 px-3 py-2">Password</th>
            ...
            <tbody>
                @if ($users)
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="border border-gray-300 px-3 py-2">{{ $users->firstItem() + $key }}</td>
                        <td class="border border-gray-300 px-3 py-2">{{ $value->name }}</td>
                        <td class="border border-gray-300 px-3 py-2">{{ $value->email }}</td>
                        <td class="border border-gray-300 px-3 py-2">{{ $value->role }}</td>
                        <td class="border border-gray-300 px-3 py-2">{{ $value->password }}</td>
