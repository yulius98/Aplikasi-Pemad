...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap -mx-3">
                ...
                <div class="w-full md:w-1/2 px-3">
                    <div class="mb-4 flex items-center">
                        <label for="nama_kategori" class="w-1/3 text-gray-700 font-semibold">Kategori</label>
                        <input type="text" id="nama_kategori" wire:model="nama_kategori" class="w-2/3 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    </div>
                </div>
            </div>
    ...
    <div class="my-3 p-6 bg-white rounded-lg shadow">
        <h4 class="text-lg font-semibold mb-4">Data Kategori</h4>
        <div class="pb-3 pt-3">
            <input type="text" placeholder="Search Kategori..." wire:model.live="cari" class="w-1/4 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
            ...
            <tbody>
                @if ($dtkategori)
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="border border-gray-300 px-3 py-2">{{ $dtkategori->firstItem() + $key }}</td>
